...
hard_svc.fit(X_train_lsi, train_target_group)

predicted = hard_svc.predict(X_test_lsi)
predicted_probs = hard_svc.predict_proba(X_test_lsi)
fpr, tpr, _ = roc_curve(test_actual, predicted_probs[:,1])

# Stats
print "Testing LSI SVM Hard Margin"
...
# Stats
print "Testing LSI SVM Soft Margin"
print_stats (test_actual, predicted)
plot_roc(fpr, tpr)
