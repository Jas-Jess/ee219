...
naive_bayes_.fit(X_train_nmf, train_target_group)
predicted = naive_bayes_.predict(X_test_nmf)
predicted_probs = naive_bayes_.predict_proba(X_test_nmf)

fpr, tpr, _ = roc_curve(test_actual, predicted_probs[:,1])

# Stats
print "Testing Naive Bayes (NMF)"
