...
log_reg.fit(X_train_nmf, train_target_group)

predicted = log_reg.predict(X_test_nmf)
predicted_probs = log_reg.predict_proba(X_test_nmf)

fpr, tpr, _ = roc_curve(test_actual, predicted_probs[:,1])

# Stats
print "Testing NMF Logistic Regresstion Classifier "
